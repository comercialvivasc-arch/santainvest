              ...
              <section id="projects-showcase" className="w-full bg-white text-zinc-900 py-20 relative border-y border-zinc-100">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                  <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 relative z-10">
                    <div>
                      <span className="text-[11px] font-bold tracking-widest text-[#FFBC00] uppercase font-mono block mb-1">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-white hover:bg-zinc-50 hover:border-[#FFBC00]/40 px-5 py-3.5 text-xs font-bold uppercase tracking-widest text-zinc-900 transition-all duration-300 shadow-sm cursor-pointer"
                        title="Abrir filtros de pesquisa"
                      >
                        <SlidersHorizontal className="h-4 w-4 text-[#FFBC00]" />
                        Filtrar Lançamentos
                      </button>
                      ...
                      <div>
                        ...
                        <span className="text-base font-extrabold text-[#FFBC00] block mt-0.5">{filteredProperties.length}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {filteredProperties.length === 0 && (
                    ...
                    >
                      <FilterX className="h-10 w-10 text-[#FFBC00] mx-auto mb-4 animate-pulse" />
                      ...
                      <p className="text-xs text-zinc-500 mt-2 leading-relaxed">
                        ...
                        <span className="block text-[#FFBC00] font-mono mt-1 font-semibold">
                          {query ? `Busca "${query}"` : ''} 
                      ...
                      <button
                        ...
                        className="mt-6 inline-flex items-center gap-1.5 rounded-xl bg-[#FFBC00] px-5 py-3 text-xs font-bold text-black uppercase tracking-wider hover:bg-[#E0A500] hover:shadow-lg hover:shadow-[#FFBC00]/20 transition-all duration-300 cursor-pointer"
                      >
