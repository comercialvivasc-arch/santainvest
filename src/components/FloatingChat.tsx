...
import { Message, BrandSettings } from '../types';
...
export default function FloatingChat({ settings }: FloatingChatProps) {
  ...
  const phoneRaw = settings?.phone || '5547999999999';
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-400 font-medium">
                    Consultora Especialista Lançamentos
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="p-4 bg-zinc-50 border-b border-zinc-100 space-y-3.5 max-h-[220px] overflow-y-auto">
              <div className="bg-white p-3 rounded-2xl rounded-tl-none border border-zinc-150 max-w-[90%] text-xs shadow-sm leading-relaxed text-zinc-800">
                Olá! Seja bem-vindo(a) ao portal de imóveis 💡
              </div>
              
              <div className="bg-white p-3 rounded-2xl rounded-tl-none border border-zinc-150 max-w-[90%] text-xs shadow-sm leading-relaxed text-zinc-800">
                Me chamo Priscilla. Vamos simular os fluxos de pagamento facilitados ou esclarecer qualquer dúvida sobre os condomínios? 🌅
              </div>
            </div>
            ...
            {isSent ? (
              <div className="p-6 text-center space-y-2.5 bg-white flex flex-col items-center justify-center">
                ...
                <p className="text-[10px] text-zinc-500">Priscilla está aguardando você na conversa!</p>
              </div>
            ) : (
              <form onSubmit={handleStartChat} className="p-4 bg-white space-y-3">
                ...
                >
                  ...
                  <span>Iniciar Chat com Priscilla</span>
                </button>
              </form>
            )}
          </motion.div>
