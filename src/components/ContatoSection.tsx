...
import { BrandSettings, Property, Message } from '../types';

interface ContatoSectionProps {
  settings: BrandSettings;
  properties: Property[];
  saveMessageToFirestore: (message: Message) => Promise<void>;
}
...
export default function ContatoSection({ 
  ...
  return (
    <div className="w-full bg-white text-zinc-900 py-16 px-6 lg:px-8 mt-1 border-t border-zinc-150 animate-fade-in" id="contato-section">
